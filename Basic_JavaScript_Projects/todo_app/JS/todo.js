...
function get_todos() {
    ...
    var todos = new Array;
    //this pulls the ltask that was saved in the web browser's memory
...
function show() {
    ...
    var html = '<ul>';
    // This displays a task to the list in the order that it is entered
...
// This will keep the inputs displayed permanently in the screen.
show();

// This creates a function to remove items when the x button is clicked
function remove() {
