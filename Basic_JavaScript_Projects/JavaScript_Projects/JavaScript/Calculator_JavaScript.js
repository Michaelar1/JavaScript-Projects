//Creqates an object to keep track of values
const Calculator = {
...
function Input_Digit(digit) {
    ...
    if (Wait_Second_Operand === true) {
        ...
        //This overwrites Display_Value if the current value is a 0, otherwise it adds onto it
...
function Handle_Operator(Next_Operator) {
    ...
    if (First_Operand == null ) {
        ...
        /* If the operator exisst, property lookup is performed for the operator
